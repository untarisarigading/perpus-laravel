                        ...
                        <form action="{{ route('petugas.update', $petugas[0]->id) }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="no_telp_petugas" id="no_telp_petugas" placeholder="telepon petugas" value="{{ $petugas[0]->no_telp_petugas }}">
                                </div>
    
                                <div class="form-group">
                                    <label for="alamat_petugas" name="alamat_petugas" id="alamat_petugas">alamat petugas</label>
                                    <input class="form-control" type="text" name="alamat_petugas" id="alamat_petugas" placeholder="alamat" value="{{ $petugas[0]->alamat_petugas }}">
                                </div>
                            </div>
